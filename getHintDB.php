...
if($r){
 ...
 while($row = mysqli_fetch_array($r) ){
	 $activityid = $row['id'];
	  echo "<tr>";
      echo "<td> <a href='activityredi.php?id=$activityid&t=2'> ".$row['name']." </a> </td>";
